...
```{r}
house <- read_csv("~/Desktop/STAT 412/kc_house_data.csv")
# View(house)
# create_report(house)
...
# Untransformed price
pairs(house[,c(3,5,6,12,13,20)], pch = 19, lower.panel = NULL)


# Log Price
pairs(house[,c(5,6,12,13,20,22)], pch = 19, lower.panel = NULL)
